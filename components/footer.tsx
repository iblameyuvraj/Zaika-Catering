    ...
    <footer className="bg-black text-gray-200 py-20" id="contact">
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-5">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center shadow-lg">
                <span className="text-white font-bold text-2xl drop-shadow-lg">Z</span>
              </div>
            ...
            <div className="flex space-x-4 pt-2">
              <a
                ...
                className="p-2 bg-white/10 rounded-full hover:scale-110 transition-all duration-200"
                aria-label="Whatsapp"
              >
              ...
              <a
                ...
                aria-label="Facebook"
              >
                <Facebook className="w-5 h-5 text-white hover:animate-bounce" />
              </a>
              <a
              ...
              >
                <Instagram className="w-5 h-5 text-white hover:animate-pulse" />
              </a>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              <a href="#wedding" className="block text-gray-300 hover:text-white transition-colors font-medium">
                Wedding Catering
              </a>
              <a href="#birthday" className="block text-gray-300 hover:text-white transition-colors font-medium">
                Birthday Parties
              </a>
              <a href="#party" className="block text-gray-300 hover:text-white transition-colors font-medium">
                Corporate Events
              </a>
              <a href="#festival" className="block text-gray-300 hover:text-white transition-colors font-medium">
                Festival Catering
              </a>
              <a href="#private" className="block text-gray-300 hover:text-white transition-colors font-medium">
                Private Dining
              </a>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <Phone className="w-4 h-4 text-white hover:animate-spin" />
                <span className="text-gray-400">+91 98765 43210</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="w-4 h-4 text-white hover:animate-pulse" />
                <span className="text-gray-400">info@zaikacatering.com</span>
              </div>
            </div>
            <form className="space-y-3">
              <Input
                ...
                className="bg-white/10 border-none rounded-lg text-white placeholder-white/40 shadow-inner focus:ring-2 focus:ring-white/30"
              />
              <Input
                type="email"
              ...
              <Textarea
                ...
                className="bg-white/10 border-none rounded-lg text-white placeholder-white/40 shadow-inner focus:ring-2 focus:ring-white/30"
              />
              <Button className="w-full bg-white/10 rounded-lg shadow-lg text-white font-bold tracking-wide hover:bg-white/20 transition-all duration-200">
                Send Message
              </Button>
            </form>
          </div>
        ...
        <div className="border-t border-white/10 mt-14 pt-8 text-center">
          <p className="text-gray-500">© 2024 Zaika Catering. All rights reserved. Crafted with <span className="text-white/80">❤️</span> in Odisha.</p>
        </div>
      </div>
    </footer>
  )
